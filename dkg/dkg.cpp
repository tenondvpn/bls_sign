...
libff::alt_bn128_G2 Dkg::GetFirstVerification(
    size_t idx, libff::alt_bn128_Fr& share, libff::alt_bn128_G2& verification_first) {
    libff::alt_bn128_G2 value = libff::alt_bn128_G2::zero();
    if ( !ThresholdUtils::ValidateKey( verification_first ) ) {
